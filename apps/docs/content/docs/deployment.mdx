...
2. Configure the Google Auth Platform branding and audience. A public hosted service
   should use a production External app and complete the applicable brand review.
...
Google. Keep the client secret only on the runtime. Gonvex requests `openid email
