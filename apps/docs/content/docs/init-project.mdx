...
<div className="docs-hero">
  ...
  <h2>Bring your frontend.<br /><em>Add a realtime Go backend.</em></h2>
  <p>
...
The generated API currently uses quoted path keys, so functions are accessed with
bracket notation such as `api["messages.list"]`.
...
- Add queries and mutations in [Functions and Bindings](./functions-and-bindings).
