...
func gonvexHostSymbols() map[string]map[string]reflect.Value {
	return map[string]map[string]reflect.Value{
		"github.com/gonvex/gonvex/pkg/gonvex/gonvex": {
			...
			"ReducerCtx":           reflect.ValueOf((*gonvex.ReducerCtx)(nil)),
			...
			"OptimisticReducer":    reflect.ValueOf(gonvex.OptimisticReducer),
			"OptimisticProjection": reflect.ValueOf(gonvex.OptimisticProjection),
